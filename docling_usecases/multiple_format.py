...
def process_document(file_path: str, converter: DocumentConverter) -> dict:
    ...
    try:
        ...
        # Save output
        output_file = f"F:/AI_testing101/docling_usecases/output/output_{Path(file_path).stem}.md"
...
def main():
    ...
    documents = [
        "F:/AI_testing101/docling_usecases/documents/DLI-RAG-Slides.pptx",
        "F:/AI_testing101/docling_usecases/documents/E-governance in India.docx",
        "F:/AI_testing101/docling_usecases/documents/KMeansDataset.csv",
        "F:/AI_testing101/docling_usecases/documents/langchain3.png",
    ]
